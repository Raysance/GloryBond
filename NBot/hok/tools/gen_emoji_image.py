...
def _emoji_template_local_dir():
    return getattr(dmc, "EmojiTemplateLocalDir", None) or os.path.join("resources","wzry_images", "emoji_template")

def _emoji_template_extra_dirs():
    return [os.path.join("resources","wzry_images", "custom_wzry_E1")]
